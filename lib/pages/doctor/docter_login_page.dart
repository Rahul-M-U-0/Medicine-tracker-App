...
import 'package:medicine_app/pages/doctor/doctor_bottomnavi.dart';
import 'package:medicine_app/pages/doctor/doctor_registerpage.dart';
                        ...
                        TextButton(
                          onPressed: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (cotext) {
                                  return const DoctorRegisterPage();
                                },
                              ),
                            );
                          },
